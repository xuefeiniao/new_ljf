...
namespace Org\Util\gtio;

class Gate{
    function gate_query_new($path, array $req = array())
    {
	
        // API settings, add your Key and Secret at here

        $key = "6D26A7FE-6563-461C-A49C-0E45DADDFE53";
        $secret = "74e7da79ab9521d582ad0886c934ae54c73041e174107b716444a9d6fb490512";
...
//		echo $res;die;
    ...
    {
        return $this->gate_query_new('1/private/balances');
    }

    function get_order_trades($order_number)
    {

        return $this->gate_query_new('1/private/orderTrades',
            array(
    ...
    function withdraw($currency, $amount, $address)
    {
        ...
        return $this->gate_query_new('1/private/withdraw',
            array(
    ...
    function get_order($order_number, $currency_pair)
    {
        ...
        return $this->gate_query_new('1/private/getOrder',
            array(
                'orderNumber' => $order_number,
    ...
    function cancel_order($order_number, $currency_pair)
    {
        ...
        return gate_query_new('1/private/cancelOrder',
            array(
                'orderNumber' => $order_number,
                'currencyPair' => strtoupper($currency_pair)
            )
    ...
    {
        return gate_query_new('1/private/cancelOrders',
//           ['orders_json'=> $orders]
    ...
    function cancel_all_orders($type, $currency_pair)
    {
        ...
        return gate_query_new('1/private/cancelAllOrders',
            array(
                'type' => $type,
                'currencyPair' => strtoupper($currency_pair)
            )
    ...
    function sell($currency_pair, $rate, $amount)
    {
        ...
        return $this->gate_query_new('1/private/sell',
            array(
                'currencyPair' => strtoupper($currency_pair),
                'rate' => $rate,
                'amount' => $amount,
    ...
    function buy($currency_pair, $rate, $amount)
    {
        ...
        return $this->gate_query_new('1/private/buy',
            array(
                'currencyPair' => strtoupper($currency_pair),
                'rate' => $rate,
                'amount' => $amount,
    ...
    function get_my_trade_history($currency_pair, $order_number)
    {
        ...
        return gate_query_new('1/private/tradeHistory',
            array(
                'currencyPair' => strtoupper($currency_pair),
                'orderNumber' => $order_number
            )
    ...
    function open_orders($currency_pair = '')
    {
        ...
        return gate_query_new('1/private/openOrders',
            array(
                'currencyPair' => strtoupper($currency_pair)
            ));
    }
    ...
    function deposites_withdrawals($start, $end)
    {
        ...
        return gate_query_new('1/private/depositsWithdrawals',
            array(
                'start' => $start,
                'end' => $end
            )
    ...
    function new_adddress($currency)
    {
        ...
        return gate_query_new('1/private/newAddress',
            array(
                'currency' => strtoupper($currency)
            )
        );
    ...
    function deposit_address($currency)
    {
        ...
        return gate_query_new('1/private/depositAddress',
            array(
                'currency' => strtoupper($currency)
            )
        );
    ...
    function check_username($username, $phone, $sign)
    {
        ...
        return gate_query_new('1/checkUsername',
            array(
                'username' => $username,
                'phone' => $phone,
                'sign' => $sign
