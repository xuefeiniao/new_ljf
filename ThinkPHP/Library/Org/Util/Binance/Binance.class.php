...
class Binance
{
    ...
    protected $api_key='Q3li6wThDSpxRm9Pakdbk4BYIv5WHHSxIfo6QVvRi502X3A7WaBfvbmCaq2oyqTK'; // /< API key that you created in the binance website member area
    protected $api_secret='ABlvmMR9uudAQhpjKa810kmMQO3I6tIMSSx50om8BR2SikKWG7C4pqnMLNtwcxq8'; // /< API secret that was given to you when you created the api key
     ...
     */
    public function buy(string $symbol, $quantity, $price,  $type = "LIMIT", array $flags = [])
    {
     ...
     */
    public function buyTest(string $symbol, $quantity, $price,  $type = "LIMIT", array $flags = [])
    {
     ...
     * @return array with error message or the order details
     */
    public function sell(string $symbol, $quantity, $price, $type = "LIMIT", array $flags = [])
    {
     ...
     * @return array with error message or empty or the order details
     */
    public function sellTest(string $symbol, $quantity, $price,  $type = "LIMIT", array $flags = [])
    {
     ...
     * @throws \Exception
     */
    public function orders(string $symbol,  $limit = 500,  $fromOrderId = 1)
    {
     ...
     * @throws \Exception
     */
    public function history(string $symbol, $limit = 500,  $fromTradeId = -1)
    {
        $parameters = [
            "symbol" => $symbol,
            "limit" => $limit,
     ...
     * @throws \Exception
     */
    private function httpRequest(string $url,  $method = "GET", array $params = [],  $signed = false)
    {
     ...
     * @throws \Exception
     */
    public function order(string $side, string $symbol, $quantity, $price,  $type = "LIMIT", array $flags = [],  $test = false)
    {
        $opt = [
            "symbol" => $symbol,
            "side" => $side,
     ...
     * @throws \Exception
     */
    public function candlesticks(string $symbol,  $interval = "5m", int $limit = null, $startTime = null, $endTime = null)
    {
     ...
     * @return null
     */
    public function sortDepth(string $symbol,  $limit = 11)
    {
