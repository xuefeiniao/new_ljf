...
//联合5个平台
function unit_ten_trades($market_name='etc_usdt'){

    //$ZB = new \Home\Controller\ZbController();
    //$zb_arr[] = $ZB->zb_get_ten_trades($market_name);


    //$Okex = new \Home\Controller\OkexController();
    //$zb_arr[] = $Okex->ok_get_ten_trades('etc_usdt');
    

    $Huobi = new \Home\Controller\HuobiController();
    $zb_arr[] = $Huobi->hb_get_ten_trades($market_name);
    echo '<pre>';
    print_r($zb_arr);

    $Bian = new \Home\Controller\BianController();
    $zb_arr[] = $Bian->bn_get_ten_trades($market_name);

    $Begg = new \Home\Controller\BeggController();
    $zb_arr[] = $Begg->bd_get_ten_trades($market_name);
