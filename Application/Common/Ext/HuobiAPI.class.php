...
define('ACCOUNT_ID', '15600359373'); // 你的账户ID
define('ACCESS_KEY','04fd7613-89857660-8ac03025-de5f1'); // 你的ACCESS_KEY
define('SECRET_KEY', 'd28f653a-64923dbd-8c6fe4cb-10cba'); // 你的SECRET_KEY

class HuobiAPI {
	private $api = 'api.huobi.pro';
	public $api_method = '';
	public $req_method = '';
//	private $ACCESS_KEY = '04fd7613-89857660-8ac03025-de5f1';
//	private $SECRET_KEY='d28f653a-64923dbd-8c6fe4cb-10cba';
//	private $ACCOUNT_ID="15600359373";
	...
	*/
	...
	function create_sign_url($append_param = []) {
		 ...
		 * */
		//echo 'https://'.$this->api.$this->api_method.'?';
		//echo $this->bind_param($param);exit;
