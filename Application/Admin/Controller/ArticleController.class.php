	...
	public function edit($id = NULL, $type = NULL)
	{
		...
		if (empty($_POST)) {
			...
			if ($type == 'images') {
				...
				if ($info) {
					$data = array('url' => str_replace('./', 'http://eraru.com/', $upload->rootPath) . $info['savename'], 'error' => 0);
				...
				//正则替换链接
					...
					$_POST['content'] = preg_replace($pregRule, '<img src="'.$url.'${1}" style="max-width:100%">', $_POST['content']);
				if ($_POST['id']) {
